...
class Interface
  ...
  def station_operation
    ...
    if i == 1
      @routes.each do |route|
        next unless route.number_route == route_number

        route.add_station(@stations.find do |st|
                            st.name_station == name_station
                          end)
      end
    elsif i == 2
      @routes.each do |route|
        ...
        route.delete_station(@stations.find do |st|
                               st.name_station == name_station
                             end)
      end
    end
  ...
  def carriages_operation
    ...
    if i == 1
      @trains.each do |train|
        next unless train.number == train_number

        train.add_carriage(@carriages.find do |carriage|
      ...
      @trains.each do |train|
        ...
        train.delete_carriage(@carriages.find do |carriage|
                                carriage.number == carriage_number
                              end)
      end
    end
  ...
  def show_trains_on_station
    ...
    @stations.each do |station|
      next unless station.name_station == name_station
  ...
  def show_all_trains
    ...
    stations.each do |station|
      ...
      station.all_trains do |train|
        puts "Train - № #{train.number}, type - #{train.type}, quantity of carriages #{train.carriages.lenght}"
      end
    end
  end
